...
import {
  ...
  getLandlordPropertyDetailVm,
} from "@/features/landlord/api";
...
export default async function PropertyDetailPage({ params }: PageProps) {
  ...
  const facts = [
    ...
    [
      "Localisation",
      [property.city, details.country].filter(Boolean).join(", "),
    ],
    ["Statut", details.status],
    ["Adresse", details.addressContent],
    [
      "Année de construction",
      details.yearBuilt ? String(details.yearBuilt) : "Non renseignée",
    ],
    [
      "Superficie",
      details.squareFootage
        ? `${details.squareFootage.toLocaleString()} pieds²`
        : "Non renseignée",
    ],
  ...
  const financialFacts = [
    ...
    //     ? formatMoney(details.currentValue)
    //     : "Non renseignée",
    // ],
    [
      "Prix d’achat",
    ...
    [
      "Unités vacantes",
      details.vacantUnits != null
        ? String(details.vacantUnits)
        : "Non renseigné",
    ],
  ];
      ...
      <PageIntro
        ...
        action={
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              className={actionButtonClassName({ variant: "primary" })}
        ...
        <div className="space-y-8 lg:col-span-5">
          <SurfaceCard className="overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="mt-3 text-sm leading-6 text-secondary-2">
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-secondary-2">Adresse</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-secondary-2">Inventaire</p>
                    <p className="text-sm font-bold text-foreground">
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {featureTags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full bg-[var(--secondary-4)] px-3 py-2 text-xs font-semibold text-secondary-2"
                      >
                        {tag}
                      </span>
                    ))}
          ...
          <SurfaceCard className="bg-[var(--secondary-4)] p-6">
            <h3 className="mb-4 text-sm font-black uppercase tracking-[0.24em] text-[var(--secondary-3)]">
          ...
          <SurfaceCard className="overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[720px]">
                <thead className="bg-[var(--secondary-4)] text-left">
                  <tr>
                    {[
                      ...
                      <th
                        key={label}
                        className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-secondary-2"
                      >
                        {label}
                      </th>
                    ))}
                ...
                <tbody>
                  {units.map((unit) => {
                    const nextPayment = paymentVm.payments.find(
                      (payment) =>
                    ...
                    return (
                      <tr key={unit.id} className="border-t border-[var(--secondary)]">
                        <td className="px-6 py-4">
                          ...
                          <p className="text-xs text-secondary-2">{unit.type}</p>
                        </td>
                        <td className="px-6 py-4">
                          <StatusBadge
                            status={unit.status}
                        ...
                        <td className="px-6 py-4 text-sm text-foreground">
                          {unit.tenantName ?? (
                            <span className="italic text-[var(--secondary-3)]">
                              Aucun bail actif
                            </span>
                          )}
                        </td>
                        <td className="px-6 py-4 text-sm text-secondary-2">
                          {nextPayment
          ...
          <SurfaceCard className="p-6">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-4">
              <div className="rounded-xl bg-[var(--secondary-4)] p-5">
                <p className="text-xs uppercase tracking-[0.2em] text-[var(--secondary-3)]">
                  Revenu mensuel
                </p>
