              ...
              <SurfaceCard className="group overflow-hidden">
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="grid flex-1 gap-6 p-6 lg:grid-cols-4 lg:items-center">
                    <div>
                      <h3 className="text-xl font-bold text-[#2a3439]">{property.name}</h3>
                      <p className="mt-2 flex items-center gap-1 text-sm text-[#566166]">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-2 rounded-full bg-[#e8eff3]">
                        <div className="h-full rounded-full bg-[#2c6a55]" style={{ width: `${occupancyRate}%` }} />
                      </div>
                    </div>
