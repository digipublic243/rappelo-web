...
export default function TenantLoginPage() {
  return (
    <main className="flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,var(--hero-tint-alt),transparent_38%),linear-gradient(180deg,var(--background),var(--background-elevated))] p-6">
      <section className="w-full max-w-lg rounded-[28px] border border-white/60 bg-white/95 p-8 shadow-[0_30px_80px_rgba(84,95,115,0.18)]">
        ...
        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-[var(--foreground)]">Bienvenue chez vous</h1>
