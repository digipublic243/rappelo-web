...
export default function TenantLoginPage() {
  return (
    <main className="flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,var(--primary-3),transparent_38%),linear-gradient(180deg,var(--background),var(--secondary-1))] p-6">
      <section className="w-full max-w-lg rounded-[28px] border border-white/60 bg-background/95 p-8 shadow-[0_30px_80px_rgba(84,95,115,0.18)]">
        <p className="text-sm font-semibold uppercase tracking-[0.24em] text-primary">Portail locataire</p>
