...
export function KpiCard({ label, value, hint }: KpiCardProps) {
  return (
    <article className="rounded-xl bg-background p-5 shadow-sm ring-1 ring-secondary-1">
      <div className="mb-4 flex items-start justify-between">
        <div className="rounded-lg bg-primary-3 px-2 py-1 text-xs font-bold uppercase tracking-wide text-primary">
          KPI
        </div>
